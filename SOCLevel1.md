...
Web Security Monitoring --> Protect and Monitor the web and its ecosystem 
Windows Security Monitoring --> Windows logging and how you can use it to detect common attacks 
Linux Security Monitoring --> Linux logging and how you can use it to detect common attacks 
Malware Concepts for SOC --> Identify common malware types, their purpose, and analyse files
Threat Analysis Tools --> Leverage threat intelligence to detect, investigate, and defend 
SIEM Triage for SOC --> learn to detect and investigate SOC alerts and correlate logs to build an incident timeline 
SOC Level 1 Capstone Challenge --> Investigate critical incidents and apply all the skills needed to be an effective SOC analyst 
